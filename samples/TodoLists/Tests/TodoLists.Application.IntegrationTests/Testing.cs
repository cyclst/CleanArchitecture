...
public partial class Testing
{
    ...
    public static async Task<string> RunAsUserAsync(string userName, string password, string[] roles)
    {
        ...
        var userManager = scope.ServiceProvider.GetRequiredService<UserManager<TodoListsUser>>();

        var user = new TodoListsUser { UserName = userName, Email = userName };
        ...
        where TEntity : class
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<TodoListsDbContext>();
